...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { email: @contacto.email, fecha_nacimiento: @contacto.fecha_nacimiento, nombre: @contacto.nombre, telefono: @contacto.telefono }
    end
  ...
  test "should update contacto" do
    patch :update, id: @contacto, contacto: { email: @contacto.email, fecha_nacimiento: @contacto.fecha_nacimiento, nombre: @contacto.nombre, telefono: @contacto.telefono }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
